                ...
                <div>
                    ...
                    <div className="flex justify-between items-center mb-7 mt-6 hover:bg-primary-navi_hover hover:bg-opacity-70 rounded-full pl-3 pr-8 py-3 transform transition-colors duration-2">
                        <div className="h-11 w-11">
                            <img className="rounded-full" src="https://i2.milimaj.com/i/milliyet/75/0x410/5d6576d6554281214c076887.jpg" />
                        </div>
                        <div className="flex flex-col">
                            <span className="font-bold text-md text-white">Shapon Pal</span>
                            <span className="text-primary-profile_color text-sm">@shaponpal</span>
                        </div>
